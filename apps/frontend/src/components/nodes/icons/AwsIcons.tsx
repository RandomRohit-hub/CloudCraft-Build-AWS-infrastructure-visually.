...
export function EcsIcon({ className = 'h-8 w-8' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 40 40" fill="none">
      <rect x="4" y="4" width="32" height="32" rx="2" fill="#ED7100" />
      <rect x="10" y="10" width="8" height="8" rx="1" stroke="white" strokeWidth="1.5" fill="none" />
      <rect x="22" y="10" width="8" height="8" rx="1" stroke="white" strokeWidth="1.5" fill="none" />
      <rect x="10" y="22" width="8" height="8" rx="1" stroke="white" strokeWidth="1.5" fill="none" />
      <rect x="22" y="22" width="8" height="8" rx="1" stroke="white" strokeWidth="1.5" fill="none" />
    </svg>
  );
}

export function DynamodbIcon({ className = 'h-8 w-8' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 40 40" fill="none">
      <rect x="4" y="4" width="32" height="32" rx="2" fill="#3B48CC" />
      <ellipse cx="20" cy="12" rx="9" ry="3.5" stroke="white" strokeWidth="1.5" fill="none" />
      <path d="M11 12v6c0 1.9 4 3.5 9 3.5s9-1.6 9-3.5v-6" stroke="white" strokeWidth="1.5" fill="none" />
      <path d="M11 18v6c0 1.9 4 3.5 9 3.5s9-1.6 9-3.5v-6" stroke="white" strokeWidth="1.5" fill="none" />
      <path d="M11 24v5c0 1.9 4 3.5 9 3.5s9-1.6 9-3.5v-5" stroke="white" strokeWidth="1.5" fill="none" />
    </svg>
  );
}

export function TargetGroupIcon({ className = 'h-8 w-8' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 40 40" fill="none">
      <rect x="4" y="4" width="32" height="32" rx="2" fill="#8C4FFF" />
      <circle cx="20" cy="20" r="10" stroke="white" strokeWidth="1.5" strokeDasharray="3 2" fill="none" />
...
export function IamRoleIcon({ className = 'h-8 w-8' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 40 40" fill="none">
      <rect x="4" y="4" width="32" height="32" rx="2" fill="#DD344C" />
      <circle cx="20" cy="15" r="5" stroke="white" strokeWidth="1.5" fill="none" />
      <path d="M12 28c0-4 3.5-7 8-7s8 3 8 7" stroke="white" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <path d="M25 10l3-3m0 0l3 3m-3-3v5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
