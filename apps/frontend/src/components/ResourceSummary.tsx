...
import type { CloudResource } from '@CloudCraft/shared';
      ...
      {hasActiveFilters && (
        <>
          ...
          <button
            ...
            className="text-xs font-medium text-orange-500 hover:text-orange-600 dark:hover:text-orange-400 ml-1 transition-colors"
          >
            Reset
          </button>
        </>
