    ...
    return (
      <div className="flex flex-col h-screen">
        ...
        <div className="flex flex-1 min-h-0">
          <div className="flex-1 relative">
            ...
            <div className="absolute top-3 left-3 right-3 z-10 flex items-center gap-2">
              <div className="flex items-center gap-1 rounded-lg bg-neutral-900/90 dark:bg-neutral-900/90 backdrop-blur-sm border border-neutral-800 dark:border-neutral-700 px-3 py-1.5 shadow-sm min-w-0">
                <ResourceSummary
              ...
              <button
                ...
                className={`flex items-center gap-1.5 rounded-lg backdrop-blur-sm border px-3 py-1.5 shadow-sm text-xs transition-colors ${
                  showSecurity
                    ...
                    : 'bg-neutral-900/90 border-neutral-800 text-neutral-400 hover:text-neutral-100 hover:border-neutral-600'
                }`}
                title="Security scan"
              >
              ...
              <button
                ...
                className=                "flex items-center gap-1.5 rounded-lg bg-neutral-900/90 backdrop-blur-sm border border-neutral-800 px-3 py-1.5 shadow-sm text-xs text-neutral-400 hover:text-neutral-100 hover:border-neutral-600 transition-colors"
              ...
              {viewMode === 'graph' && (
                <div className="relative">
                  ...
                  {showLayoutMenu && (
                    <div className="absolute right-0 top-full mt-1 w-36 rounded-lg bg-neutral-900 border border-neutral-800 shadow-lg shadow-black/50 py-1 z-50">
                        ...
                        <button
                          ...
                          className={`flex items-center gap-2 w-full px-3 py-2 text-xs transition-colors ${
                            layoutMode === opt.value
                              ? 'text-orange-400 bg-orange-950/30 font-medium'
              ...
              <div className="relative">
                ...
                {showExportMenu && (
                  <div className="absolute right-0 top-full mt-1 w-48 rounded-lg bg-neutral-900 border border-neutral-800 shadow-lg shadow-black/50 py-1 z-50">
                    <button
                      onMouseDown={() => { canvasRef.current?.exportPng(); setShowExportMenu(false); }}
                      className="flex items-center gap-2.5 w-full px-3 py-2 text-xs text-neutral-300 hover:bg-neutral-800 transition-colors"
                    >
                      ...
                      <div className="text-left">
                        ...
                        <span className="block text-[10px] text-neutral-500">Static screenshot</span>
                      </div>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <div className="text-left">
                        ...
                        <span className="block text-[10px] text-neutral-500">Shareable, works offline</span>
                      </div>
                    </button>
                  </div>
                )}
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg bg-orange-600 hover:bg-orange-700 text-white px-3 py-1.5 shadow-sm shadow-orange-500/30 text-xs font-semibold transition-colors"
                title="Open Design Mode (Blank Canvas / AWS Architect)"
              >
                <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                </svg>
                <span className="hidden xl:inline">Design Mode</span>
              </button>
            ...
            {(() => {
              ...
              return (
                <div className="absolute bottom-4 left-3 z-10 flex items-center gap-3 rounded-xl bg-neutral-900/90 backdrop-blur-sm border border-neutral-800 px-4 py-2.5 shadow-lg">
                  <span
          ...
          {showSecurity ? (
            <div className="w-72 xl:w-80 border-l border-neutral-800 bg-neutral-950 p-4 pt-16 overflow-y-auto shadow-sm shrink-0 animate-slide-in">
              <SecurityPanel
                resources={state.data.resources}
                edges={state.data.edges}
                providerConfig={providerConfig}
        ...
        {showShortcuts && (
          ...
          >
            <div
              className="bg-neutral-950 rounded-xl shadow-2xl border border-neutral-800 p-6 w-80"
            ...
            >
                ...
                {[
                  ...
                  <div key={desc} className="flex items-center justify-between">
                    ...
                    <div className="flex gap-1">
                      {keys.map((k) => (
                        <kbd key={k} className="px-2 py-0.5 text-xs font-mono rounded bg-neutral-800 text-neutral-300 border border-neutral-700">
                          {k}
                        </kbd>
                      ))}
                    </div>
              ...
              <p className="mt-4 text-xs text-neutral-500 text-center">Press <kbd className="px-1 py-0.5 text-[10px] font-mono rounded bg-neutral-800 border border-neutral-700">?</kbd> or <kbd className="px-1 py-0.5 text-[10px] font-mono rounded bg-neutral-800 border border-neutral-700">Esc</kbd> to close</p>
            </div>
          </div>
        )}
      </div>
