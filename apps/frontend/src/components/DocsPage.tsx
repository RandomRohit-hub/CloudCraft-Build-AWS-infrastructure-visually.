...
const searchIndex: SearchEntry[] = [
  // Overview
  { section: 'overview', title: 'What is CloudCraft?', text: 'CloudCraft is an open-source infrastructure visualization platform that transforms Terraform, CloudFormation, and CDK code into interactive architecture diagrams. Multi-cloud support for AWS Azure GCP. Connect GitHub repos, upload files, or call the API.' },
  ...
  // Quick Start
  { section: 'quickstart', title: 'Upload your IaC file', text: 'Drop a .tfstate, .tf, .yaml, .json, or .template file onto the upload zone, or click to browse. CloudCraft auto-detects the cloud provider and IaC tool. Supported formats: Terraform state files, HCL configuration files, CloudFormation templates, CDK-synthesized templates.' },
  { section: 'quickstart', title: 'Parse and visualize', text: 'Click Parse to send the file to the backend. CloudCraft extracts resources, resolves relationships and dependencies, and builds a nested graph with VPCs, subnets laid out automatically.' },
...
function OverviewSection({ onNavigate }: { onNavigate: (s: Section) => void }) {
  return (
    <div className="space-y-12">
      ...
      <SectionHeading
        badge="Documentation"
        title="CloudCraft Documentation"
        subtitle="CloudCraft is an open-source infrastructure visualization platform that transforms your Terraform, CloudFormation, and CDK code into interactive, multi-cloud architecture diagrams — in seconds."
      />
      ...
      <div className="gradient-border">
        <ScreenshotShowcase
          ...
          alt="CloudCraft AWS architecture diagram showing VPCs, subnets, EC2 instances, and other resources"
      ...
      <div className="space-y-5">
        ...
        <div className="grid sm:grid-cols-3 gap-5">
          {[
            ...
            { step: '2', title: 'Parse & Analyze', desc: 'CloudCraft extracts resources, resolves dependencies, and detects the cloud provider.' },
  ...
  return (
    <div className="space-y-10">
      ...
      <ScreenshotShowcase
        ...
        alt="CloudCraft home page with upload zone, GitHub connect button, and sample infrastructure buttons"
        caption="CloudCraft home page — upload files, connect GitHub, or try sample infrastructure"
      />
      ...
      <div className="space-y-3">
        ...
        <p className="text-slate-500 dark:text-slate-400 ml-14">
          ...
          CloudCraft auto-detects the IaC tool and cloud provider from your file content.
        </p>
      ...
      <div className="space-y-3">
        ...
        <p className="text-slate-500 dark:text-slate-400 ml-14">
          Click <strong>Parse</strong> to send the file to the backend. CloudCraft extracts resources,
  ...
  return (
    <div className="space-y-12">
      <SectionHeading
        badge="Features"
        title="Features"
        subtitle="CloudCraft goes beyond visualization — analyze blast radius, estimate costs, scan for security issues, and export interactive diagrams."
      />
      ...
      <div id="blast-radius">
        <FeatureShowcaseCard
          ...
          description="Select any resource and click Blast Radius in the detail panel to visualize its impact zone. CloudCraft traces all transitive dependencies and highlights affected resources with depth-based color coding."
      ...
      <div id="security">
        <FeatureShowcaseCard
          ...
          description="Click the security badge in the toolbar to scan your infrastructure for common security issues. CloudCraft checks resources against built-in rules and reports findings grouped by severity."
...
# Upload plan.json to CloudCraft`}</CodeBlock>
            </div>
          </div>
          <div>
            <ScreenshotShowcase
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div id="history" className="docs-card-glow p-6 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/20 space-y-4 sm:col-span-2">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              <p className="text-sm text-slate-500 dark:text-slate-400">
                When signed in with Google, CloudCraft automatically saves every diagram you parse.
            ...
            <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700">
              <p className="text-xs text-slate-400 dark:text-slate-500">
                Session history requires Google sign-in via Supabase. CloudCraft works fully in guest mode — sessions just won&#39;t be persisted.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">
          CloudCraft uses GitHub OAuth to securely access your repositories. Your token is stored
        ...
        <ol className="text-sm text-slate-500 dark:text-slate-400 space-y-3 ml-4">
          ...
          <li className="flex items-start gap-2">
            ...
            <span>Authorize CloudCraft — the popup closes and you&#39;re connected</span>
          </li>
          <li className="flex items-start gap-2">
      ...
      <div className="space-y-4">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {[
            ...
            { title: 'Auto-Scan', desc: 'CloudCraft scans the entire repository tree to find directories containing .tf files — no manual path entry needed.' },
      ...
      <div className="p-5 rounded-2xl bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-500/5 dark:to-green-500/5 border border-emerald-200 dark:border-emerald-500/20">
        ...
        <ul className="text-sm text-slate-600 dark:text-slate-400 space-y-2">
          <li className="flex items-start gap-2">
            <span className="text-green-500 shrink-0">&#10003;</span>
            <span>GitHub tokens are stored in your browser only — never on CloudCraft servers</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-green-500 shrink-0">&#10003;</span>
  ...
  return (
    <div className="space-y-10">
      <SectionHeading
        ...
        title="Providers"
        subtitle="CloudCraft supports three major cloud providers with automatic detection and provider-branded visual components."
      />

      <div className="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
        <p className="text-sm text-slate-500 dark:text-slate-400">
          <strong className="text-slate-700 dark:text-slate-300">Auto-detection:</strong>{' '}
          CloudCraft detects the cloud provider from resource type prefixes
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">
          CloudCraft automatically nests resources inside their parent containers based on provider configuration:
        </p>
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-3 text-lg text-slate-500 dark:text-slate-400">
          CloudCraft exposes a full REST API for programmatic access. Integrate infrastructure
